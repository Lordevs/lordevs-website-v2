...
export function CareerCard({ title, features, tags }: CareerCardProps) {
  return (
    <NavLink to={ROUTES.CAREER_APPLY}>
      <TiltCard>
        <div
          className="relative h-full overflow-hidden rounded-[22px] border-px border-[#4F1AD626] p-4 transition-all duration-500 ease-in-out group cursor-pointer hover:shadow-[0_4px_32px_0_rgba(59,130,246,0.5)] hover:border-[#4F1AD650] lg:w-full"
          style={{
            background:
              "radial-gradient(43% 50% at 50% 50%, #0F091226, #0C0912)",
          }}>
          <div className="absolute top-[-84px] left-[345px] h-[205px] w-[162px] bg-linear-to-r from-[#00B1FE] to-[#504EFF] opacity-30 blur-[103.4px] transition-opacity duration-500 group-hover:opacity-50" />
          ...
          <div className="relative z-10 flex flex-col items-end">
            <Button
              variant="gradient"
              className="mt-2 shadow-none pointer-events-none">
              Apply now →
            </Button>
          </div>
        </div>
