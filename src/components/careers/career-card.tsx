...
export function CareerCard({ title, features, tags }: CareerCardProps) {
  return (
    <TiltCard>
      <div
        className="relative overflow-hidden rounded-[22px] border-[1px] border-[#4F1AD626] p-4 hover:shadow-[0_4px_32px_0_rgba(59,130,246,0.5)] lg:w-full"
        style={{
          background: 'radial-gradient(43% 50% at 50% 50%, #0F091226, #0C0912)',
        }}
      >
        <div className="absolute top-[-84px] left-[345px] h-[205px] w-[162px] bg-gradient-to-r from-[#00B1FE] to-[#504EFF] opacity-30 blur-[103.4px]" />
        ...
        <Separator className="mb-4 h-[1px] bg-gradient-to-r from-[#FFFFFF05] via-[#FFFFFF1A] to-[#FFFFFF05]" />
