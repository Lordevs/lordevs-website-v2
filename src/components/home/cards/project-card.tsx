...
export function ProjectCard({
  ...
  return (
    <motion.div whileHover={{ scale: 1.01 }} transition={{ duration: 0.3 }}>
      <Link href={ROUTES.CASE_STUDY(slug)}>
        <Card className="rounded-4xl border-[#939393] bg-[#080808] px-3 py-4 backdrop-blur-sm transition-colors hover:bg-[#080808]/70 hover:shadow-[0_4px_32px_0_rgba(59,130,246,0.5)]">
          <div className="flex flex-col gap-4 md:gap-6 lg:flex-row">
            ...
            >
              <div className="absolute top-[-84px] left-[325px] h-[205px] w-[162px] bg-gradient-to-r from-[#00B1FE] to-[#504EFF] opacity-30 blur-[103.4px]" />

              <div className="mb-2 flex items-center space-x-2">
                <h3 className="mb-1 text-xl font-bold text-white md:text-2xl">
                  {title}
                </h3>
                <p className="bg-gradient-to-r from-[#00B2FF] to-[#8F00FF] bg-clip-text text-xs text-transparent md:text-sm">
                  {subtitle}
                </p>
              </div>
