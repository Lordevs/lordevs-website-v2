...
export function NewsCard({
  ...
  return (
    <NavLink to={ROUTES.NEWS_ARTICLE(slug)}>
      <TiltCard className="h-full">
        <motion.div
          ...
          <div className="relative h-48 w-full overflow-hidden z-10 p-4">
          ...
          <div className="relative flex flex-1 flex-col justify-between p-5 z-10">
            <div>
