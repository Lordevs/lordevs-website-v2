    ...
    <section className="mx-auto max-w-6xl bg-black py-10 md:py-20">
      <div className="container mx-auto space-y-4 px-6 text-center">
        ...
        <div className="relative mt-12 hidden grid-cols-1 gap-2 md:grid md:grid-cols-2 md:gap-1">
          ...
          <div className="absolute top-2 bottom-2 left-1/2 hidden w-1 -translate-x-1/2 rounded-lg bg-linear-to-b from-[#00B1FE] to-[#504EFF] md:block" />
          <div className="absolute top-1/2 right-2 left-2 hidden h-1 -translate-y-1/2 rounded-lg bg-linear-to-r from-[#00B1FE] to-[#504EFF] md:block" />
          <div className="absolute top-1/4 left-3/4 z-0 h-[282px] w-[282px] -translate-x-1/2 -translate-y-1/3 rounded-full bg-linear-to-r from-[#00B1FE] to-[#504EFF] blur-[84px]" />
        </div>
