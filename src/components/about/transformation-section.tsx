...
function ServiceCard({ icon: Icon, tag, title, children }: ServiceCardProps) {
  return (
    <div className="relative h-full rounded-4xl bg-gradient-to-r from-[#ACACAC] via-[#303030] via-[47.06%] to-[#ACACAC] p-[1px] hover:shadow-[0_4px_32px_0_rgba(59,130,246,0.5)]">
      <ShineBorder
      ...
      <div className="relative flex h-full flex-col rounded-4xl bg-[#080808] px-10 py-8">
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="relative inline-block rounded-full bg-gradient-to-l from-[#202020] from-[20.61%] to-[#FFFFFF] p-[1px]">
            ...
            <span
              className={cn(
                ...
                '-left-1 bg-gradient-to-r from-[#00B2FF] to-[#504EFF]'
              )}
            />
          </div>
        </div>
        ...
        <Separator className="mb-4 h-[1px] !w-2/3 bg-gradient-to-r from-[#FFFFFF05] via-[#FFFFFF1A] to-[#FFFFFF05]" />
        <p className="flex-grow text-base text-white md:text-xl">{children}</p>
      </div>
    </div>
  );
}
