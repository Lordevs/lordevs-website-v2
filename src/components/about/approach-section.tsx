...
function ApproachCard({
  ...
  return (
    <div className="relative flex h-full min-h-[250px] flex-1 flex-col bg-black md:min-h-[450px]">
      {/* Number backdrop */}
      <div className="mb-2 ml-1 w-fit bg-linear-to-br from-[#00B1FE] to-[#504EFF] to-70% bg-clip-text text-[1.5rem] font-bold text-clip text-transparent md:mb-0 md:ml-5 md:block md:text-[4rem]">
      ...
      <div
        ...
        <div className="w-[283px] rotate-1 rounded-xl bg-linear-to-r from-[#00B1FE] to-[#504EFF] opacity-30 blur-[181.47px]" />
