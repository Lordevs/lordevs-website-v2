...
export default function StatsCard({
  ...
  return (
    <Card
      className={`group relative border ${config.border} bg-gradient-to-br ${config.gradient} backdrop-blur-sm transition-all duration-300 hover:shadow-lg ${config.glow}`}
    >
      <div
        className={`absolute inset-0 rounded-lg bg-gradient-to-br ${config.blur} opacity-50 blur-sm transition-opacity duration-300 group-hover:opacity-70`}
      />
