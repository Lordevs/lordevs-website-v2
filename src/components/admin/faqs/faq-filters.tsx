    ...
    <div className="mb-6 flex flex-col gap-4 sm:flex-row">
      <div className="relative flex-1">
        ...
        <Input
          ...
          className="border-blue-500/30 bg-gradient-to-r from-[#23243A]/50 to-[#181A20]/50 pl-10 text-white placeholder-gray-400 backdrop-blur-sm focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20"
        />
      </div>
      ...
      >
        <SelectTrigger className="rounded-lg border border-blue-500/30 bg-gradient-to-r from-[#23243A]/50 to-[#181A20]/50 px-3 py-2 text-white backdrop-blur-sm focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 focus:outline-none">
