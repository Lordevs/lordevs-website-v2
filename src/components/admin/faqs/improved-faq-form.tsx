...
import { AVAILABLE_PAGES, FAQFormData } from '@/constants/admin';
    ...
    >
      <div>
        ...
        <Input
          ...
          className="border-blue-500/30 bg-gradient-to-r from-[#23243A]/50 to-[#181A20]/50 text-white placeholder-gray-400 backdrop-blur-sm focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20"
          required
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full resize-none rounded-lg border border-blue-500/30 bg-gradient-to-r from-[#23243A]/50 to-[#181A20]/50 p-3 text-white placeholder-gray-400 backdrop-blur-sm transition-all duration-300 focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 focus:outline-none disabled:opacity-50"
          rows={4}
          required
          disabled={isSubmitting}
        />
            ...
            <button
              ...
              className={`rounded-lg border p-3 text-sm font-medium transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed ${
                formData.pages.includes(page.id)
                  ? 'border-blue-500/50 bg-gradient-to-r from-[#00B2FF]/20 to-[#8F00FF]/20 text-blue-400 shadow-lg shadow-blue-500/20'
                  : 'border-gray-600/50 bg-gradient-to-r from-[#23243A]/30 to-[#181A20]/30 text-gray-400 hover:border-blue-500/30 hover:text-blue-400'
              }`}
            >
              {page.label}
            </button>
      ...
      <div className="flex items-center space-x-3">
        <input
          ...
          disabled={isSubmitting}
          className="rounded border-blue-500/30 bg-gradient-to-r from-[#23243A]/50 to-[#181A20]/50 text-blue-600 focus:ring-blue-500/50 disabled:opacity-50"
        />
