              ...
              {extendedTestimonials.map((testimonial, index) => {
                ...
                return (
                  <TiltCard key={index + "-" + testimonial.id}>
                    <motion.div
                      className="group w-[300px] shrink-0 cursor-pointer md:w-[360px]"
                      ...
                      <div
                        ...
                        {/* Hover Glow Effect */}
                        <div className="pointer-events-none absolute inset-0 rounded-2xl bg-linear-to-r from-blue-500/5 to-purple-500/5 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                      </div>
                    </motion.div>
                  </TiltCard>
                );
