...
export default function TermsConditionsPage() {
  return (
    <PolicyLayout
      ...
      description="Understand the terms and conditions for using the DotCode website and services. Review our intellectual property rights and user responsibilities."
      ...
      <div className="space-y-12">
        <section className="space-y-4">
          ...
          <p>
            ...
            ("you") and DotCode ("we," "us" or "our"), concerning your access to
        ...
        <section className="space-y-4">
          ...
          <p>
            Unless otherwise indicated, the Website as well as all source code,
            databases, functionality, software, website designs, audio, video,
            text, photographs, and graphics on the Website (collectively, the
