...
export default function PrivacyPolicyPage() {
  return (
    <PolicyLayout
      ...
      description="Read the DotCode Privacy Policy to understand how we collect, use, and protect your personal information. Your privacy is our top priority."
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              ...
              us and the Website, the choices you make and the products and
              features you use.
            </li>
            <li>
              Information automatically collected. We automatically collect
              certain information when you visit, use or navigate the Website.
