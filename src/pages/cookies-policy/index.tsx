...
export default function CookiesPolicyPage() {
  return (
    <PolicyLayout
      ...
      description="Learn about how DotCode uses cookies and similar technologies to provide a better browsing experience and improve our services."
      ...
      <div className="space-y-12">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-4">
            ...
            <li>
              ...
              our Website but are non-essential to their use.
            </li>
            <li>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            the Cookie Consent Manager or in your web browser settings.
          </p>
        </section>
      </div>
    </PolicyLayout>
